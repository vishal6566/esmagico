...
const CustomerSay = () => {
  return (
    ...
    <Box w={'100%'}  pl={'80px'} pt={'50px'} bgColor={'#f8f9fa'}>
<Flex justifyContent={'center'} mt={'30px'} gap={6}  pos={'relative'}>
    ...
    <Text fontSize={'44px'} fontWeight={'600'} lineHeight={'60px'}>What Our Customer Says</Text>
</Flex>
<Flex>
    <Box pos={'relative'}>
        ...
        <Image src={customer} pos={'absolute'} top={10} left={20}/>
    </Box>
    <Box mt={'30px'}>
        <Image src={quote} />
       
    </Box>
    <Box w={'45%'} mt={'65px'} ml={'20px'}>
